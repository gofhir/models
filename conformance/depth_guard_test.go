...
// TestDepthGuardResistsKeyCasing covers a bypass of the guard itself.
//
...
// its subtree at every level, which is the cost the guard exists to bound.
//
// Measured against the unfixed code: 55 KB of nesting spelled RESOURCETYPE cost
// 466 ms of CPU and 179 MB of heap, scaling quadratically. Four of the five
// spellings below were accepted; only the canonical one was rejected.
