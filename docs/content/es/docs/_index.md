...
- **Serialización XML** -- `MarshalXML` y `UnmarshalXML` en cada tipo. La narrativa y las extensiones sobre primitivos se preservan, y el corpus publicado hace round-trip de 3653/3653. Consulta [XML Marshaling](serialization/xml-marshaling/).
