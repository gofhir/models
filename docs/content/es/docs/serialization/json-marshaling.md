...
Medido sobre los corpus oficiales de ejemplos, 8751 de 8758 archivos JSON (99,9 %) sobreviven un round-trip sin cambios. Clasificando los 7 que no, por todas las diferencias presentes y no solo por la primera:
