...
func (b TestScriptScope) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if err := xmlEncodePrimitiveString(e, "artifact", b.Artifact, nil); err != nil {
		return err
	}
...
func (b TestScriptSetupActionAssert) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if err := xmlEncodePrimitiveCode(e, "defaultManualCompletion", b.DefaultManualCompletion, nil); err != nil {
		return err
	}
	...
	if err := xmlEncodePrimitiveBool(e, "stopTestOnFail", b.StopTestOnFail, nil); err != nil {
		return err
	}
	...
	for {
		...
		case xml.StartElement:
			...
			case "defaultManualCompletion":
				v, _, err := xmlDecodePrimitiveCode[AssertionManualCompletionType](d, t)
				if err != nil {
					return err
				}
