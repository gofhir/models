...
// deviceUsageTypeMarker occupies no memory and serializes as the constant
// "DeviceUsage". It replaces a string field that a per-resource MarshalJSON had
...
type deviceUsageTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (deviceUsageTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"DeviceUsage"`), nil
}
...
func (*deviceUsageTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "DeviceUsage")
}

// DeviceUsage represents FHIR DeviceUsage.
type DeviceUsage struct {
	// FHIR resource type. Emitted automatically; see deviceUsageTypeMarker.
	ResourceType deviceUsageTypeMarker `json:"resourceType"`
...
func (r *DeviceUsage) GetExtensionByURL(url string) *Extension {
...
func (r *DeviceUsage) GetExtensionsByURL(url string) []*Extension {
...
func (r *DeviceUsage) HasExtensionByURL(url string) bool {
...
func (r *DeviceUsage) GetModifierExtensionByURL(url string) *Extension {
...
func (r *DeviceUsageAdherence) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *DeviceUsageAdherence) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *DeviceUsageAdherence) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *DeviceUsageAdherence) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
