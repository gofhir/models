...
// regulatedAuthorizationTypeMarker occupies no memory and serializes as the constant
// "RegulatedAuthorization". It replaces a string field that a per-resource MarshalJSON had
...
type regulatedAuthorizationTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (regulatedAuthorizationTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"RegulatedAuthorization"`), nil
}
...
func (*regulatedAuthorizationTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "RegulatedAuthorization")
}

// RegulatedAuthorization represents FHIR RegulatedAuthorization.
type RegulatedAuthorization struct {
	// FHIR resource type. Emitted automatically; see regulatedAuthorizationTypeMarker.
	ResourceType regulatedAuthorizationTypeMarker `json:"resourceType"`
...
func (r *RegulatedAuthorization) GetExtensionByURL(url string) *Extension {
...
func (r *RegulatedAuthorization) GetExtensionsByURL(url string) []*Extension {
...
func (r *RegulatedAuthorization) HasExtensionByURL(url string) bool {
...
func (r *RegulatedAuthorization) GetModifierExtensionByURL(url string) *Extension {
...
func (r *RegulatedAuthorizationCase) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *RegulatedAuthorizationCase) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *RegulatedAuthorizationCase) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *RegulatedAuthorizationCase) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
