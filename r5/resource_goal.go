...
func (r Goal) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if err := xmlEncodePrimitiveBool(e, "continuous", r.Continuous, r.ContinuousExt); err != nil {
		return err
	}
	if r.Priority != nil {
...
// SetContinuousExt sets the extensions carried by Continuous, serialized as
// "_continuous".
//
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *GoalBuilder) SetContinuousExt(v Element) *GoalBuilder {
	b.goal.ContinuousExt = &v
	return b
}
