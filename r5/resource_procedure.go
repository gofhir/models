...
// procedureTypeMarker occupies no memory and serializes as the constant
// "Procedure". It replaces a string field that a per-resource MarshalJSON had
...
type procedureTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (procedureTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"Procedure"`), nil
}
...
func (*procedureTypeMarker) UnmarshalJSON([]byte) error { return nil }

// Procedure represents FHIR Procedure.
type Procedure struct {
	// FHIR resource type. Emitted automatically; see procedureTypeMarker.
	ResourceType procedureTypeMarker `json:"resourceType"`
