...
// personTypeMarker occupies no memory and serializes as the constant
// "Person". It replaces a string field that a per-resource MarshalJSON had
...
type personTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (personTypeMarker) MarshalJSON() ([]byte, error) {
...
func (*personTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Person")
}

// Person represents FHIR Person.
type Person struct {
	// FHIR resource type. Emitted automatically; see personTypeMarker.
	ResourceType personTypeMarker `json:"resourceType"`
...
func (r *Person) GetExtensionByURL(url string) *Extension {
...
func (r *Person) GetExtensionsByURL(url string) []*Extension {
...
func (r *Person) HasExtensionByURL(url string) bool {
...
func (r *Person) GetModifierExtensionByURL(url string) *Extension {
...
func (r *PersonCommunication) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *PersonCommunication) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *PersonCommunication) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *PersonCommunication) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}

// MarshalXML serializes PersonCommunication to FHIR-conformant XML.
func (b PersonCommunication) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if start.Name.Local == "" {
		start.Name.Local = "Person.communication"
	}
	if b.Id != nil {
...
// UnmarshalXML deserializes PersonCommunication from FHIR-conformant XML.
func (r *PersonCommunication) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
...
//
// The result points into the slice, so writing through it edits the value.
func (r *PersonLink) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *PersonLink) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *PersonLink) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *PersonLink) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
