...
func (r MedicationDispense) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if r.NotPerformedReason != nil {
		if err := r.NotPerformedReason.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "notPerformedReason"}}); err != nil {
			return err
		}
	}
...
func (b MedicationDispenseSubstitution) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if b.ResponsibleParty != nil {
		if err := b.ResponsibleParty.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "responsibleParty"}}); err != nil {
			return err
		}
	}
