...
func (*diagnosticReportTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "DiagnosticReport")
}
...
func (r *DiagnosticReport) GetExtensionByURL(url string) *Extension {
...
func (r *DiagnosticReport) GetExtensionsByURL(url string) []*Extension {
...
func (r *DiagnosticReport) HasExtensionByURL(url string) bool {
...
func (r *DiagnosticReport) GetModifierExtensionByURL(url string) *Extension {
...
func (r *DiagnosticReportMedia) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *DiagnosticReportMedia) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *DiagnosticReportMedia) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *DiagnosticReportMedia) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *DiagnosticReportSupportingInfo) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *DiagnosticReportSupportingInfo) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *DiagnosticReportSupportingInfo) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *DiagnosticReportSupportingInfo) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
// =============================================================================
// DiagnosticReportSupportingInfo - Fluent Builder
// =============================================================================

// DiagnosticReportSupportingInfoBuilder provides a fluent API for constructing DiagnosticReportSupportingInfo values.
type DiagnosticReportSupportingInfoBuilder struct {
	diagnosticReportSupportingInfo *DiagnosticReportSupportingInfo
}

// NewDiagnosticReportSupportingInfoBuilder creates a new DiagnosticReportSupportingInfoBuilder.
func NewDiagnosticReportSupportingInfoBuilder() *DiagnosticReportSupportingInfoBuilder {
	return &DiagnosticReportSupportingInfoBuilder{
		diagnosticReportSupportingInfo: &DiagnosticReportSupportingInfo{},
	}
}

// Build returns the constructed DiagnosticReportSupportingInfo.
//
// A value, not a pointer: every consumer of a datatype takes one. Patient.Name is
// []HumanName so AddName wants a HumanName, and a pointer field like Range.Low is
// set through SetLow(Quantity), which takes the address itself. Returning *T meant
// writing AddName(*NewHumanNameBuilder()...Build()) — a dereference at every call
// site, to undo a pointer nobody asked for.
func (b *DiagnosticReportSupportingInfoBuilder) Build() DiagnosticReportSupportingInfo {
	return *b.diagnosticReportSupportingInfo
}

// SetId sets the Id field.
func (b *DiagnosticReportSupportingInfoBuilder) SetId(v string) *DiagnosticReportSupportingInfoBuilder {
	b.diagnosticReportSupportingInfo.Id = &v
	return b
}

// AddExtension adds a Extension element.
func (b *DiagnosticReportSupportingInfoBuilder) AddExtension(v Extension) *DiagnosticReportSupportingInfoBuilder {
	b.diagnosticReportSupportingInfo.Extension = append(b.diagnosticReportSupportingInfo.Extension, v)
	return b
}

// AddModifierExtension adds a ModifierExtension element.
func (b *DiagnosticReportSupportingInfoBuilder) AddModifierExtension(v Extension) *DiagnosticReportSupportingInfoBuilder {
	b.diagnosticReportSupportingInfo.ModifierExtension = append(b.diagnosticReportSupportingInfo.ModifierExtension, v)
	return b
}

// SetType sets the Type field.
func (b *DiagnosticReportSupportingInfoBuilder) SetType(v CodeableConcept) *DiagnosticReportSupportingInfoBuilder {
	b.diagnosticReportSupportingInfo.Type = &v
	return b
}

// SetReference sets the Reference field.
func (b *DiagnosticReportSupportingInfoBuilder) SetReference(v Reference) *DiagnosticReportSupportingInfoBuilder {
	b.diagnosticReportSupportingInfo.Reference = &v
	return b
}
