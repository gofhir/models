...
// deviceAssociationTypeMarker occupies no memory and serializes as the constant
// "DeviceAssociation". It replaces a string field that a per-resource MarshalJSON had
...
type deviceAssociationTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (deviceAssociationTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"DeviceAssociation"`), nil
}
...
func (*deviceAssociationTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "DeviceAssociation")
}

// DeviceAssociation represents FHIR DeviceAssociation.
type DeviceAssociation struct {
	// FHIR resource type. Emitted automatically; see deviceAssociationTypeMarker.
	ResourceType deviceAssociationTypeMarker `json:"resourceType"`
...
func (r *DeviceAssociation) GetExtensionByURL(url string) *Extension {
...
func (r *DeviceAssociation) GetExtensionsByURL(url string) []*Extension {
...
func (r *DeviceAssociation) HasExtensionByURL(url string) bool {
...
func (r *DeviceAssociation) GetModifierExtensionByURL(url string) *Extension {
...
func (r *DeviceAssociationOperation) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *DeviceAssociationOperation) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *DeviceAssociationOperation) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *DeviceAssociationOperation) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
