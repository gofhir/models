...
//
// The result points into the slice, so writing through it edits the value.
func (r *PlanDefinitionActionInput) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *PlanDefinitionActionInput) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *PlanDefinitionActionInput) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *PlanDefinitionActionInput) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *PlanDefinitionActionOutput) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *PlanDefinitionActionOutput) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *PlanDefinitionActionOutput) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *PlanDefinitionActionOutput) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *PlanDefinitionActor) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *PlanDefinitionActor) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *PlanDefinitionActor) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *PlanDefinitionActor) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *PlanDefinitionActorOption) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *PlanDefinitionActorOption) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *PlanDefinitionActorOption) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *PlanDefinitionActorOption) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionBuilder) SetCopyrightLabelExt(v Element) *PlanDefinitionBuilder {
	b.planDefinition.CopyrightLabelExt = &v
	return b
}
...
func (b *PlanDefinitionActionBuilder) SetLinkId(v string) *PlanDefinitionActionBuilder {
	b.planDefinitionAction.LinkId = &v
	return b
}
...
func (b *PlanDefinitionActionBuilder) SetCode(v CodeableConcept) *PlanDefinitionActionBuilder {
	b.planDefinitionAction.Code = &v
	return b
}
...
func (b *PlanDefinitionActionBuilder) AddInput(v PlanDefinitionActionInput) *PlanDefinitionActionBuilder {
	b.planDefinitionAction.Input = append(b.planDefinitionAction.Input, v)
	return b
}

// AddOutput adds a Output element.
func (b *PlanDefinitionActionBuilder) AddOutput(v PlanDefinitionActionOutput) *PlanDefinitionActionBuilder {
...
func (b *PlanDefinitionActionBuilder) SetLocation(v CodeableReference) *PlanDefinitionActionBuilder {
	b.planDefinitionAction.Location = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionBuilder) SetLinkIdExt(v Element) *PlanDefinitionActionBuilder {
	b.planDefinitionAction.LinkIdExt = &v
	return b
}
...
// =============================================================================
// PlanDefinitionActionInput - Fluent Builder
// =============================================================================

// PlanDefinitionActionInputBuilder provides a fluent API for constructing PlanDefinitionActionInput values.
type PlanDefinitionActionInputBuilder struct {
	planDefinitionActionInput *PlanDefinitionActionInput
}

// NewPlanDefinitionActionInputBuilder creates a new PlanDefinitionActionInputBuilder.
func NewPlanDefinitionActionInputBuilder() *PlanDefinitionActionInputBuilder {
	return &PlanDefinitionActionInputBuilder{
		planDefinitionActionInput: &PlanDefinitionActionInput{},
	}
}

// Build returns the constructed PlanDefinitionActionInput.
//
// A value, not a pointer: every consumer of a datatype takes one. Patient.Name is
// []HumanName so AddName wants a HumanName, and a pointer field like Range.Low is
// set through SetLow(Quantity), which takes the address itself. Returning *T meant
// writing AddName(*NewHumanNameBuilder()...Build()) — a dereference at every call
// site, to undo a pointer nobody asked for.
func (b *PlanDefinitionActionInputBuilder) Build() PlanDefinitionActionInput {
	return *b.planDefinitionActionInput
}

// SetId sets the Id field.
func (b *PlanDefinitionActionInputBuilder) SetId(v string) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.Id = &v
	return b
}

// AddExtension adds a Extension element.
func (b *PlanDefinitionActionInputBuilder) AddExtension(v Extension) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.Extension = append(b.planDefinitionActionInput.Extension, v)
	return b
}

// AddModifierExtension adds a ModifierExtension element.
func (b *PlanDefinitionActionInputBuilder) AddModifierExtension(v Extension) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.ModifierExtension = append(b.planDefinitionActionInput.ModifierExtension, v)
	return b
}

// SetTitle sets the Title field.
func (b *PlanDefinitionActionInputBuilder) SetTitle(v string) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.Title = &v
	return b
}

// SetRequirement sets the Requirement field.
func (b *PlanDefinitionActionInputBuilder) SetRequirement(v DataRequirement) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.Requirement = &v
	return b
}

// SetRelatedData sets the RelatedData field.
func (b *PlanDefinitionActionInputBuilder) SetRelatedData(v string) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.RelatedData = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionInputBuilder) SetTitleExt(v Element) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.TitleExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionInputBuilder) SetRelatedDataExt(v Element) *PlanDefinitionActionInputBuilder {
	b.planDefinitionActionInput.RelatedDataExt = &v
	return b
}

// =============================================================================
// PlanDefinitionActionOutput - Fluent Builder
// =============================================================================

// PlanDefinitionActionOutputBuilder provides a fluent API for constructing PlanDefinitionActionOutput values.
type PlanDefinitionActionOutputBuilder struct {
	planDefinitionActionOutput *PlanDefinitionActionOutput
}

// NewPlanDefinitionActionOutputBuilder creates a new PlanDefinitionActionOutputBuilder.
func NewPlanDefinitionActionOutputBuilder() *PlanDefinitionActionOutputBuilder {
	return &PlanDefinitionActionOutputBuilder{
		planDefinitionActionOutput: &PlanDefinitionActionOutput{},
	}
}

// Build returns the constructed PlanDefinitionActionOutput.
//
// A value, not a pointer: every consumer of a datatype takes one. Patient.Name is
// []HumanName so AddName wants a HumanName, and a pointer field like Range.Low is
// set through SetLow(Quantity), which takes the address itself. Returning *T meant
// writing AddName(*NewHumanNameBuilder()...Build()) — a dereference at every call
// site, to undo a pointer nobody asked for.
func (b *PlanDefinitionActionOutputBuilder) Build() PlanDefinitionActionOutput {
	return *b.planDefinitionActionOutput
}

// SetId sets the Id field.
func (b *PlanDefinitionActionOutputBuilder) SetId(v string) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.Id = &v
	return b
}

// AddExtension adds a Extension element.
func (b *PlanDefinitionActionOutputBuilder) AddExtension(v Extension) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.Extension = append(b.planDefinitionActionOutput.Extension, v)
	return b
}

// AddModifierExtension adds a ModifierExtension element.
func (b *PlanDefinitionActionOutputBuilder) AddModifierExtension(v Extension) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.ModifierExtension = append(b.planDefinitionActionOutput.ModifierExtension, v)
	return b
}

// SetTitle sets the Title field.
func (b *PlanDefinitionActionOutputBuilder) SetTitle(v string) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.Title = &v
	return b
}

// SetRequirement sets the Requirement field.
func (b *PlanDefinitionActionOutputBuilder) SetRequirement(v DataRequirement) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.Requirement = &v
	return b
}

// SetRelatedData sets the RelatedData field.
func (b *PlanDefinitionActionOutputBuilder) SetRelatedData(v string) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.RelatedData = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionOutputBuilder) SetTitleExt(v Element) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.TitleExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionOutputBuilder) SetRelatedDataExt(v Element) *PlanDefinitionActionOutputBuilder {
	b.planDefinitionActionOutput.RelatedDataExt = &v
	return b
}
...
func (b *PlanDefinitionActionParticipantBuilder) SetActorId(v string) *PlanDefinitionActionParticipantBuilder {
	b.planDefinitionActionParticipant.ActorId = &v
	return b
}

// SetType sets the Type field.
func (b *PlanDefinitionActionParticipantBuilder) SetType(v ActivityParticipantType) *PlanDefinitionActionParticipantBuilder {
	b.planDefinitionActionParticipant.Type = &v
	return b
}

// SetTypeCanonical sets the TypeCanonical field.
func (b *PlanDefinitionActionParticipantBuilder) SetTypeCanonical(v string) *PlanDefinitionActionParticipantBuilder {
	b.planDefinitionActionParticipant.TypeCanonical = &v
	return b
}

// SetTypeReference sets the TypeReference field.
func (b *PlanDefinitionActionParticipantBuilder) SetTypeReference(v Reference) *PlanDefinitionActionParticipantBuilder {
	b.planDefinitionActionParticipant.TypeReference = &v
	return b
}
...
func (b *PlanDefinitionActionParticipantBuilder) SetFunction(v CodeableConcept) *PlanDefinitionActionParticipantBuilder {
	b.planDefinitionActionParticipant.Function = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionParticipantBuilder) SetActorIdExt(v Element) *PlanDefinitionActionParticipantBuilder {
	b.planDefinitionActionParticipant.ActorIdExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionParticipantBuilder) SetTypeCanonicalExt(v Element) *PlanDefinitionActionParticipantBuilder {
	b.planDefinitionActionParticipant.TypeCanonicalExt = &v
	return b
}
...
func (b *PlanDefinitionActionRelatedActionBuilder) SetTargetId(v string) *PlanDefinitionActionRelatedActionBuilder {
	b.planDefinitionActionRelatedAction.TargetId = &v
	return b
}
...
func (b *PlanDefinitionActionRelatedActionBuilder) SetEndRelationship(v ActionRelationshipType) *PlanDefinitionActionRelatedActionBuilder {
	b.planDefinitionActionRelatedAction.EndRelationship = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionRelatedActionBuilder) SetTargetIdExt(v Element) *PlanDefinitionActionRelatedActionBuilder {
	b.planDefinitionActionRelatedAction.TargetIdExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActionRelatedActionBuilder) SetEndRelationshipExt(v Element) *PlanDefinitionActionRelatedActionBuilder {
	b.planDefinitionActionRelatedAction.EndRelationshipExt = &v
	return b
}
...
// =============================================================================
// PlanDefinitionActor - Fluent Builder
// =============================================================================

// PlanDefinitionActorBuilder provides a fluent API for constructing PlanDefinitionActor values.
type PlanDefinitionActorBuilder struct {
	planDefinitionActor *PlanDefinitionActor
}

// NewPlanDefinitionActorBuilder creates a new PlanDefinitionActorBuilder.
func NewPlanDefinitionActorBuilder() *PlanDefinitionActorBuilder {
	return &PlanDefinitionActorBuilder{
		planDefinitionActor: &PlanDefinitionActor{},
	}
}

// Build returns the constructed PlanDefinitionActor.
//
// A value, not a pointer: every consumer of a datatype takes one. Patient.Name is
// []HumanName so AddName wants a HumanName, and a pointer field like Range.Low is
// set through SetLow(Quantity), which takes the address itself. Returning *T meant
// writing AddName(*NewHumanNameBuilder()...Build()) — a dereference at every call
// site, to undo a pointer nobody asked for.
func (b *PlanDefinitionActorBuilder) Build() PlanDefinitionActor {
	return *b.planDefinitionActor
}

// SetId sets the Id field.
func (b *PlanDefinitionActorBuilder) SetId(v string) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.Id = &v
	return b
}

// AddExtension adds a Extension element.
func (b *PlanDefinitionActorBuilder) AddExtension(v Extension) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.Extension = append(b.planDefinitionActor.Extension, v)
	return b
}

// AddModifierExtension adds a ModifierExtension element.
func (b *PlanDefinitionActorBuilder) AddModifierExtension(v Extension) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.ModifierExtension = append(b.planDefinitionActor.ModifierExtension, v)
	return b
}

// SetTitle sets the Title field.
func (b *PlanDefinitionActorBuilder) SetTitle(v string) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.Title = &v
	return b
}

// SetDescription sets the Description field.
func (b *PlanDefinitionActorBuilder) SetDescription(v string) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.Description = &v
	return b
}

// AddOption adds a Option element.
func (b *PlanDefinitionActorBuilder) AddOption(v PlanDefinitionActorOption) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.Option = append(b.planDefinitionActor.Option, v)
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActorBuilder) SetTitleExt(v Element) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.TitleExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActorBuilder) SetDescriptionExt(v Element) *PlanDefinitionActorBuilder {
	b.planDefinitionActor.DescriptionExt = &v
	return b
}

// =============================================================================
// PlanDefinitionActorOption - Fluent Builder
// =============================================================================

// PlanDefinitionActorOptionBuilder provides a fluent API for constructing PlanDefinitionActorOption values.
type PlanDefinitionActorOptionBuilder struct {
	planDefinitionActorOption *PlanDefinitionActorOption
}

// NewPlanDefinitionActorOptionBuilder creates a new PlanDefinitionActorOptionBuilder.
func NewPlanDefinitionActorOptionBuilder() *PlanDefinitionActorOptionBuilder {
	return &PlanDefinitionActorOptionBuilder{
		planDefinitionActorOption: &PlanDefinitionActorOption{},
	}
}

// Build returns the constructed PlanDefinitionActorOption.
//
// A value, not a pointer: every consumer of a datatype takes one. Patient.Name is
// []HumanName so AddName wants a HumanName, and a pointer field like Range.Low is
// set through SetLow(Quantity), which takes the address itself. Returning *T meant
// writing AddName(*NewHumanNameBuilder()...Build()) — a dereference at every call
// site, to undo a pointer nobody asked for.
func (b *PlanDefinitionActorOptionBuilder) Build() PlanDefinitionActorOption {
	return *b.planDefinitionActorOption
}

// SetId sets the Id field.
func (b *PlanDefinitionActorOptionBuilder) SetId(v string) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.Id = &v
	return b
}

// AddExtension adds a Extension element.
func (b *PlanDefinitionActorOptionBuilder) AddExtension(v Extension) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.Extension = append(b.planDefinitionActorOption.Extension, v)
	return b
}

// AddModifierExtension adds a ModifierExtension element.
func (b *PlanDefinitionActorOptionBuilder) AddModifierExtension(v Extension) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.ModifierExtension = append(b.planDefinitionActorOption.ModifierExtension, v)
	return b
}

// SetType sets the Type field.
func (b *PlanDefinitionActorOptionBuilder) SetType(v ActivityParticipantType) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.Type = &v
	return b
}

// SetTypeCanonical sets the TypeCanonical field.
func (b *PlanDefinitionActorOptionBuilder) SetTypeCanonical(v string) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.TypeCanonical = &v
	return b
}

// SetTypeReference sets the TypeReference field.
func (b *PlanDefinitionActorOptionBuilder) SetTypeReference(v Reference) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.TypeReference = &v
	return b
}

// SetRole sets the Role field.
func (b *PlanDefinitionActorOptionBuilder) SetRole(v CodeableConcept) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.Role = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActorOptionBuilder) SetTypeExt(v Element) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.TypeExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *PlanDefinitionActorOptionBuilder) SetTypeCanonicalExt(v Element) *PlanDefinitionActorOptionBuilder {
	b.planDefinitionActorOption.TypeCanonicalExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *PlanDefinitionGoalTargetBuilder) SetDetailString(v string) *PlanDefinitionGoalTargetBuilder {
	b.clearDetail()
	b.planDefinitionGoalTarget.DetailString = &v
	return b
}

// SetDetailStringExt sets the DetailStringExt field.
func (b *PlanDefinitionGoalTargetBuilder) SetDetailStringExt(v Element) *PlanDefinitionGoalTargetBuilder {
	b.planDefinitionGoalTarget.DetailStringExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *PlanDefinitionGoalTargetBuilder) SetDetailBoolean(v bool) *PlanDefinitionGoalTargetBuilder {
	b.clearDetail()
	b.planDefinitionGoalTarget.DetailBoolean = &v
	return b
}

// SetDetailBooleanExt sets the DetailBooleanExt field.
func (b *PlanDefinitionGoalTargetBuilder) SetDetailBooleanExt(v Element) *PlanDefinitionGoalTargetBuilder {
	b.planDefinitionGoalTarget.DetailBooleanExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *PlanDefinitionGoalTargetBuilder) SetDetailInteger(v int) *PlanDefinitionGoalTargetBuilder {
	b.clearDetail()
	b.planDefinitionGoalTarget.DetailInteger = &v
	return b
}

// SetDetailIntegerExt sets the DetailIntegerExt field.
func (b *PlanDefinitionGoalTargetBuilder) SetDetailIntegerExt(v Element) *PlanDefinitionGoalTargetBuilder {
	b.planDefinitionGoalTarget.DetailIntegerExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *PlanDefinitionGoalTargetBuilder) SetDetailRatio(v Ratio) *PlanDefinitionGoalTargetBuilder {
	b.clearDetail()
	b.planDefinitionGoalTarget.DetailRatio = &v
	return b
}
...
func (b *PlanDefinitionGoalTargetBuilder) clearDetail() {
	...
	b.planDefinitionGoalTarget.DetailString = nil
	b.planDefinitionGoalTarget.DetailStringExt = nil
	b.planDefinitionGoalTarget.DetailBoolean = nil
	b.planDefinitionGoalTarget.DetailBooleanExt = nil
	b.planDefinitionGoalTarget.DetailInteger = nil
	b.planDefinitionGoalTarget.DetailIntegerExt = nil
	b.planDefinitionGoalTarget.DetailRatio = nil
}
