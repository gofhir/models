...
// medicationRequestTypeMarker occupies no memory and serializes as the constant
// "MedicationRequest". It replaces a string field that a per-resource MarshalJSON had
...
type medicationRequestTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (medicationRequestTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"MedicationRequest"`), nil
}
...
func (*medicationRequestTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "MedicationRequest")
}

// MedicationRequest represents FHIR MedicationRequest.
type MedicationRequest struct {
	// FHIR resource type. Emitted automatically; see medicationRequestTypeMarker.
	ResourceType medicationRequestTypeMarker `json:"resourceType"`
...
func (r *MedicationRequest) GetExtensionByURL(url string) *Extension {
...
func (r *MedicationRequest) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicationRequest) HasExtensionByURL(url string) bool {
...
func (r *MedicationRequest) GetModifierExtensionByURL(url string) *Extension {
...
func (r *MedicationRequestDispenseRequest) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicationRequestDispenseRequest) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicationRequestDispenseRequest) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *MedicationRequestDispenseRequest) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *MedicationRequestDispenseRequestInitialFill) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicationRequestDispenseRequestInitialFill) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicationRequestDispenseRequestInitialFill) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *MedicationRequestDispenseRequestInitialFill) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *MedicationRequestSubstitution) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicationRequestSubstitution) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicationRequestSubstitution) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *MedicationRequestSubstitution) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *MedicationRequestBuilder) SetStatusChangedExt(v Element) *MedicationRequestBuilder {
	b.medicationRequest.StatusChangedExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *MedicationRequestBuilder) SetReportedExt(v Element) *MedicationRequestBuilder {
	b.medicationRequest.ReportedExt = &v
	return b
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *MedicationRequestBuilder) SetRenderedDosageInstructionExt(v Element) *MedicationRequestBuilder {
	b.medicationRequest.RenderedDosageInstructionExt = &v
	return b
}
...
// SetDispenser sets the Dispenser field.
func (b *MedicationRequestDispenseRequestBuilder) SetDispenser(v Reference) *MedicationRequestDispenseRequestBuilder {
	b.medicationRequestDispenseRequest.Dispenser = &v
	return b
}

// AddDispenserInstruction adds a DispenserInstruction element.
func (b *MedicationRequestDispenseRequestBuilder) AddDispenserInstruction(v Annotation) *MedicationRequestDispenseRequestBuilder {
	b.medicationRequestDispenseRequest.DispenserInstruction = append(b.medicationRequestDispenseRequest.DispenserInstruction, v)
	return b
}

// SetDoseAdministrationAid sets the DoseAdministrationAid field.
func (b *MedicationRequestDispenseRequestBuilder) SetDoseAdministrationAid(v CodeableConcept) *MedicationRequestDispenseRequestBuilder {
	b.medicationRequestDispenseRequest.DoseAdministrationAid = &v
	return b
}
