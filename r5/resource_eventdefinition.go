...
func (r *EventDefinition) GetExtensionByURL(url string) *Extension {
...
func (r *EventDefinition) GetExtensionsByURL(url string) []*Extension {
...
func (r *EventDefinition) HasExtensionByURL(url string) bool {
...
func (r *EventDefinition) GetModifierExtensionByURL(url string) *Extension {
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *EventDefinitionBuilder) SetCopyrightLabelExt(v Element) *EventDefinitionBuilder {
	b.eventDefinition.CopyrightLabelExt = &v
	return b
}
