...
// riskAssessmentTypeMarker occupies no memory and serializes as the constant
// "RiskAssessment". It replaces a string field that a per-resource MarshalJSON had
...
type riskAssessmentTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (riskAssessmentTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"RiskAssessment"`), nil
}
...
func (*riskAssessmentTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "RiskAssessment")
}

// RiskAssessment represents FHIR RiskAssessment.
type RiskAssessment struct {
	// FHIR resource type. Emitted automatically; see riskAssessmentTypeMarker.
	ResourceType riskAssessmentTypeMarker `json:"resourceType"`
...
func (r *RiskAssessment) GetExtensionByURL(url string) *Extension {
...
func (r *RiskAssessment) GetExtensionsByURL(url string) []*Extension {
...
func (r *RiskAssessment) HasExtensionByURL(url string) bool {
...
func (r *RiskAssessment) GetModifierExtensionByURL(url string) *Extension {
...
func (r *RiskAssessmentPrediction) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *RiskAssessmentPrediction) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *RiskAssessmentPrediction) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *RiskAssessmentPrediction) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
