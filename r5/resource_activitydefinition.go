...
func (*activityDefinitionTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "ActivityDefinition")
}
...
func (r *ActivityDefinition) HasExtensionByURL(url string) bool {
...
// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ActivityDefinitionDynamicValue) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ActivityDefinitionParticipant) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (b *ActivityDefinitionBuilder) clearVersionAlgorithm() {
	b.activityDefinition.VersionAlgorithmString = nil
	b.activityDefinition.VersionAlgorithmCoding = nil
}
...
// _field companions of the primitive ones.
func (b *ActivityDefinitionBuilder) clearAsNeeded() {
	b.activityDefinition.AsNeededBoolean = nil
	b.activityDefinition.AsNeededCodeableConcept = nil
}
