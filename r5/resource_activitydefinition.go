...
// activityDefinitionTypeMarker occupies no memory and serializes as the constant
// "ActivityDefinition". It replaces a string field that a per-resource MarshalJSON had
...
type activityDefinitionTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (activityDefinitionTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"ActivityDefinition"`), nil
}
...
func (*activityDefinitionTypeMarker) UnmarshalJSON([]byte) error { return nil }

// ActivityDefinition represents FHIR ActivityDefinition.
type ActivityDefinition struct {
	// FHIR resource type. Emitted automatically; see activityDefinitionTypeMarker.
	ResourceType activityDefinitionTypeMarker `json:"resourceType"`
