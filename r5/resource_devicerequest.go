...
func (*deviceRequestTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "DeviceRequest")
}
...
func (r *DeviceRequest) GetExtensionByURL(url string) *Extension {
...
func (r *DeviceRequest) GetExtensionsByURL(url string) []*Extension {
...
func (r *DeviceRequest) HasExtensionByURL(url string) bool {
...
func (r *DeviceRequest) GetModifierExtensionByURL(url string) *Extension {
...
func (r *DeviceRequestParameter) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *DeviceRequestParameter) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *DeviceRequestParameter) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *DeviceRequestParameter) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
