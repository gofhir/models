...
func (*coverageTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Coverage")
}
...
func (r *Coverage) GetExtensionByURL(url string) *Extension {
...
func (r *Coverage) GetExtensionsByURL(url string) []*Extension {
...
func (r *Coverage) HasExtensionByURL(url string) bool {
...
func (r *Coverage) GetModifierExtensionByURL(url string) *Extension {
...
func (r *CoverageClass) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *CoverageClass) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *CoverageClass) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *CoverageClass) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *CoverageCostToBeneficiary) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *CoverageCostToBeneficiary) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *CoverageCostToBeneficiary) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *CoverageCostToBeneficiary) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *CoverageCostToBeneficiaryException) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *CoverageCostToBeneficiaryException) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *CoverageCostToBeneficiaryException) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *CoverageCostToBeneficiaryException) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *CoveragePaymentBy) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *CoveragePaymentBy) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *CoveragePaymentBy) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *CoveragePaymentBy) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *CoverageBuilder) SetKindExt(v Element) *CoverageBuilder {
	b.coverage.KindExt = &v
	return b
}
...
func (b *CoverageClassBuilder) SetValue(v Identifier) *CoverageClassBuilder {
...
func (b *CoverageCostToBeneficiaryBuilder) SetCategory(v CodeableConcept) *CoverageCostToBeneficiaryBuilder {
	b.coverageCostToBeneficiary.Category = &v
	return b
}

// SetNetwork sets the Network field.
func (b *CoverageCostToBeneficiaryBuilder) SetNetwork(v CodeableConcept) *CoverageCostToBeneficiaryBuilder {
	b.coverageCostToBeneficiary.Network = &v
	return b
}

// SetUnit sets the Unit field.
func (b *CoverageCostToBeneficiaryBuilder) SetUnit(v CodeableConcept) *CoverageCostToBeneficiaryBuilder {
	b.coverageCostToBeneficiary.Unit = &v
	return b
}

// SetTerm sets the Term field.
func (b *CoverageCostToBeneficiaryBuilder) SetTerm(v CodeableConcept) *CoverageCostToBeneficiaryBuilder {
	b.coverageCostToBeneficiary.Term = &v
	return b
}
...
// =============================================================================
// CoveragePaymentBy - Fluent Builder
// =============================================================================

// CoveragePaymentByBuilder provides a fluent API for constructing CoveragePaymentBy values.
type CoveragePaymentByBuilder struct {
	coveragePaymentBy *CoveragePaymentBy
}

// NewCoveragePaymentByBuilder creates a new CoveragePaymentByBuilder.
func NewCoveragePaymentByBuilder() *CoveragePaymentByBuilder {
	return &CoveragePaymentByBuilder{
		coveragePaymentBy: &CoveragePaymentBy{},
	}
}

// Build returns the constructed CoveragePaymentBy.
//
// A value, not a pointer: every consumer of a datatype takes one. Patient.Name is
// []HumanName so AddName wants a HumanName, and a pointer field like Range.Low is
// set through SetLow(Quantity), which takes the address itself. Returning *T meant
// writing AddName(*NewHumanNameBuilder()...Build()) — a dereference at every call
// site, to undo a pointer nobody asked for.
func (b *CoveragePaymentByBuilder) Build() CoveragePaymentBy {
	return *b.coveragePaymentBy
}

// SetId sets the Id field.
func (b *CoveragePaymentByBuilder) SetId(v string) *CoveragePaymentByBuilder {
	b.coveragePaymentBy.Id = &v
	return b
}

// AddExtension adds a Extension element.
func (b *CoveragePaymentByBuilder) AddExtension(v Extension) *CoveragePaymentByBuilder {
	b.coveragePaymentBy.Extension = append(b.coveragePaymentBy.Extension, v)
	return b
}

// AddModifierExtension adds a ModifierExtension element.
func (b *CoveragePaymentByBuilder) AddModifierExtension(v Extension) *CoveragePaymentByBuilder {
	b.coveragePaymentBy.ModifierExtension = append(b.coveragePaymentBy.ModifierExtension, v)
	return b
}

// SetParty sets the Party field.
func (b *CoveragePaymentByBuilder) SetParty(v Reference) *CoveragePaymentByBuilder {
	b.coveragePaymentBy.Party = &v
	return b
}

// SetResponsibility sets the Responsibility field.
func (b *CoveragePaymentByBuilder) SetResponsibility(v string) *CoveragePaymentByBuilder {
	b.coveragePaymentBy.Responsibility = &v
	return b
}

// SetResponsibilityExt sets the extensions carried by Responsibility, serialized as
// "_responsibility".
//
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *CoveragePaymentByBuilder) SetResponsibilityExt(v Element) *CoveragePaymentByBuilder {
	b.coveragePaymentBy.ResponsibilityExt = &v
	return b
}
