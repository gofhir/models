...
func (r *Task) HasExtensionURL(url string) bool {
...
// HasExtensionURL reports whether any extension carries the given URL, which is
// the whole meaning of the extensions that have no value.
func (r *TaskInput) HasExtensionURL(url string) bool {
	return HasExtensionURL(r.Extension, url)
}
...
// HasExtensionURL reports whether any extension carries the given URL, which is
// the whole meaning of the extensions that have no value.
func (r *TaskOutput) HasExtensionURL(url string) bool {
	return HasExtensionURL(r.Extension, url)
}
...
// HasExtensionURL reports whether any extension carries the given URL, which is
// the whole meaning of the extensions that have no value.
func (r *TaskPerformer) HasExtensionURL(url string) bool {
	return HasExtensionURL(r.Extension, url)
}
...
// HasExtensionURL reports whether any extension carries the given URL, which is
// the whole meaning of the extensions that have no value.
func (r *TaskRestriction) HasExtensionURL(url string) bool {
	return HasExtensionURL(r.Extension, url)
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *TaskBuilder) SetDoNotPerformExt(v Element) *TaskBuilder {
	b.task.DoNotPerformExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskInputBuilder) SetValueInteger64(v Integer64) *TaskInputBuilder {
	b.clearValue()
	b.taskInput.ValueInteger64 = &v
	return b
}

// SetValueInteger64Ext sets the ValueInteger64Ext field.
func (b *TaskInputBuilder) SetValueInteger64Ext(v Element) *TaskInputBuilder {
	b.taskInput.ValueInteger64Ext = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskInputBuilder) SetValueCodeableReference(v CodeableReference) *TaskInputBuilder {
	b.clearValue()
	b.taskInput.ValueCodeableReference = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskInputBuilder) SetValueRatioRange(v RatioRange) *TaskInputBuilder {
	b.clearValue()
	b.taskInput.ValueRatioRange = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskInputBuilder) SetValueAvailability(v Availability) *TaskInputBuilder {
	b.clearValue()
	b.taskInput.ValueAvailability = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskInputBuilder) SetValueExtendedContactDetail(v ExtendedContactDetail) *TaskInputBuilder {
	b.clearValue()
	b.taskInput.ValueExtendedContactDetail = &v
	return b
}
...
func (b *TaskInputBuilder) clearValue() {
	...
	b.taskInput.ValueInteger64 = nil
	b.taskInput.ValueInteger64Ext = nil
	...
	b.taskInput.ValueCodeableReference = nil
	...
	b.taskInput.ValueRatioRange = nil
	...
	b.taskInput.ValueAvailability = nil
	b.taskInput.ValueExtendedContactDetail = nil
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskOutputBuilder) SetValueInteger64(v Integer64) *TaskOutputBuilder {
	b.clearValue()
	b.taskOutput.ValueInteger64 = &v
	return b
}

// SetValueInteger64Ext sets the ValueInteger64Ext field.
func (b *TaskOutputBuilder) SetValueInteger64Ext(v Element) *TaskOutputBuilder {
	b.taskOutput.ValueInteger64Ext = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskOutputBuilder) SetValueCodeableReference(v CodeableReference) *TaskOutputBuilder {
	b.clearValue()
	b.taskOutput.ValueCodeableReference = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskOutputBuilder) SetValueRatioRange(v RatioRange) *TaskOutputBuilder {
	b.clearValue()
	b.taskOutput.ValueRatioRange = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskOutputBuilder) SetValueAvailability(v Availability) *TaskOutputBuilder {
	b.clearValue()
	b.taskOutput.ValueAvailability = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *TaskOutputBuilder) SetValueExtendedContactDetail(v ExtendedContactDetail) *TaskOutputBuilder {
	b.clearValue()
	b.taskOutput.ValueExtendedContactDetail = &v
	return b
}
...
func (b *TaskOutputBuilder) clearValue() {
	...
	b.taskOutput.ValueInteger64 = nil
	b.taskOutput.ValueInteger64Ext = nil
	...
	b.taskOutput.ValueCodeableReference = nil
	...
	b.taskOutput.ValueRatioRange = nil
	...
	b.taskOutput.ValueAvailability = nil
	b.taskOutput.ValueExtendedContactDetail = nil
	b.taskOutput.ValueDosage = nil
	b.taskOutput.ValueMeta = nil
}

// =============================================================================
// TaskPerformer - Fluent Builder
// =============================================================================

// TaskPerformerBuilder provides a fluent API for constructing TaskPerformer values.
type TaskPerformerBuilder struct {
	taskPerformer *TaskPerformer
}

// NewTaskPerformerBuilder creates a new TaskPerformerBuilder.
func NewTaskPerformerBuilder() *TaskPerformerBuilder {
	return &TaskPerformerBuilder{
		taskPerformer: &TaskPerformer{},
	}
}

// Build returns the constructed TaskPerformer.
//
// A value, not a pointer: every consumer of a datatype takes one. Patient.Name is
// []HumanName so AddName wants a HumanName, and a pointer field like Range.Low is
// set through SetLow(Quantity), which takes the address itself. Returning *T meant
// writing AddName(*NewHumanNameBuilder()...Build()) — a dereference at every call
// site, to undo a pointer nobody asked for.
func (b *TaskPerformerBuilder) Build() TaskPerformer {
	return *b.taskPerformer
}

// SetId sets the Id field.
func (b *TaskPerformerBuilder) SetId(v string) *TaskPerformerBuilder {
	b.taskPerformer.Id = &v
	return b
}

// AddExtension adds a Extension element.
func (b *TaskPerformerBuilder) AddExtension(v Extension) *TaskPerformerBuilder {
	b.taskPerformer.Extension = append(b.taskPerformer.Extension, v)
	return b
}

// AddModifierExtension adds a ModifierExtension element.
func (b *TaskPerformerBuilder) AddModifierExtension(v Extension) *TaskPerformerBuilder {
	b.taskPerformer.ModifierExtension = append(b.taskPerformer.ModifierExtension, v)
	return b
}

// SetFunction sets the Function field.
func (b *TaskPerformerBuilder) SetFunction(v CodeableConcept) *TaskPerformerBuilder {
	b.taskPerformer.Function = &v
	return b
}

// SetActor sets the Actor field.
func (b *TaskPerformerBuilder) SetActor(v Reference) *TaskPerformerBuilder {
	b.taskPerformer.Actor = &v
	return b
}
