...
func (*communicationRequestTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "CommunicationRequest")
}
...
func (r *CommunicationRequest) GetExtensionByURL(url string) *Extension {
...
func (r *CommunicationRequest) GetExtensionsByURL(url string) []*Extension {
...
func (r *CommunicationRequest) HasExtensionByURL(url string) bool {
...
func (r *CommunicationRequest) GetModifierExtensionByURL(url string) *Extension {
...
func (r *CommunicationRequestPayload) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *CommunicationRequestPayload) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *CommunicationRequestPayload) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *CommunicationRequestPayload) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *CommunicationRequestBuilder) SetIntentExt(v Element) *CommunicationRequestBuilder {
	b.communicationRequest.IntentExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *CommunicationRequestPayloadBuilder) SetContentCodeableConcept(v CodeableConcept) *CommunicationRequestPayloadBuilder {
	b.clearContent()
	b.communicationRequestPayload.ContentCodeableConcept = &v
	return b
}
...
func (b *CommunicationRequestPayloadBuilder) clearContent() {
	...
	b.communicationRequestPayload.ContentCodeableConcept = nil
}
