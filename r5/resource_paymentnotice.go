...
func (r *PaymentNotice) GetExtensionByURL(url string) *Extension {
...
func (r *PaymentNotice) GetExtensionsByURL(url string) []*Extension {
...
func (r *PaymentNotice) HasExtensionByURL(url string) bool {
...
func (r *PaymentNotice) GetModifierExtensionByURL(url string) *Extension {
