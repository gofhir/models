...
func (*actorDefinitionTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "ActorDefinition")
}
...
func (r *ActorDefinition) GetExtensionByURL(url string) *Extension {
...
func (r *ActorDefinition) GetExtensionsByURL(url string) []*Extension {
...
func (r *ActorDefinition) HasExtensionByURL(url string) bool {
...
func (r *ActorDefinition) GetModifierExtensionByURL(url string) *Extension {
