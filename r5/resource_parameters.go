...
func (b *ParametersParameter) UnmarshalJSON(data []byte) error {
	...
	if err := json.Unmarshal(data, aux); err != nil {
		...
		return unwrapAliasError(err, "Parameters.parameter")
	}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *ParametersParameterBuilder) SetValueInteger64(v Integer64) *ParametersParameterBuilder {
	b.clearValue()
	b.parametersParameter.ValueInteger64 = &v
	return b
}

// SetValueInteger64Ext sets the ValueInteger64Ext field.
func (b *ParametersParameterBuilder) SetValueInteger64Ext(v Element) *ParametersParameterBuilder {
	b.parametersParameter.ValueInteger64Ext = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *ParametersParameterBuilder) SetValueCodeableReference(v CodeableReference) *ParametersParameterBuilder {
	b.clearValue()
	b.parametersParameter.ValueCodeableReference = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *ParametersParameterBuilder) SetValueRatioRange(v RatioRange) *ParametersParameterBuilder {
	b.clearValue()
	b.parametersParameter.ValueRatioRange = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *ParametersParameterBuilder) SetValueAvailability(v Availability) *ParametersParameterBuilder {
	b.clearValue()
	b.parametersParameter.ValueAvailability = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *ParametersParameterBuilder) SetValueExtendedContactDetail(v ExtendedContactDetail) *ParametersParameterBuilder {
	b.clearValue()
	b.parametersParameter.ValueExtendedContactDetail = &v
	return b
}
...
func (b *ParametersParameterBuilder) clearValue() {
	...
	b.parametersParameter.ValueInteger64 = nil
	b.parametersParameter.ValueInteger64Ext = nil
	...
	b.parametersParameter.ValueCodeableReference = nil
	...
	b.parametersParameter.ValueRatioRange = nil
	...
	b.parametersParameter.ValueAvailability = nil
	b.parametersParameter.ValueExtendedContactDetail = nil
