...
func (*basicTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Basic")
}
...
func (r *Basic) GetExtensionByURL(url string) *Extension {
...
func (r *Basic) GetExtensionsByURL(url string) []*Extension {
...
func (r *Basic) HasExtensionByURL(url string) bool {
...
func (r *Basic) GetModifierExtensionByURL(url string) *Extension {
