...
// formularyItemTypeMarker occupies no memory and serializes as the constant
// "FormularyItem". It replaces a string field that a per-resource MarshalJSON had
...
type formularyItemTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (formularyItemTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"FormularyItem"`), nil
}
...
func (*formularyItemTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "FormularyItem")
}

// FormularyItem represents FHIR FormularyItem.
type FormularyItem struct {
	// FHIR resource type. Emitted automatically; see formularyItemTypeMarker.
	ResourceType formularyItemTypeMarker `json:"resourceType"`
...
func (r *FormularyItem) GetExtensionByURL(url string) *Extension {
...
func (r *FormularyItem) GetExtensionsByURL(url string) []*Extension {
...
func (r *FormularyItem) HasExtensionByURL(url string) bool {
...
func (r *FormularyItem) GetModifierExtensionByURL(url string) *Extension {
