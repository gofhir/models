...
// nutritionIntakeTypeMarker occupies no memory and serializes as the constant
// "NutritionIntake". It replaces a string field that a per-resource MarshalJSON had
...
type nutritionIntakeTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (nutritionIntakeTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"NutritionIntake"`), nil
}
...
func (*nutritionIntakeTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "NutritionIntake")
}

// NutritionIntake represents FHIR NutritionIntake.
type NutritionIntake struct {
	// FHIR resource type. Emitted automatically; see nutritionIntakeTypeMarker.
	ResourceType nutritionIntakeTypeMarker `json:"resourceType"`
...
func (r *NutritionIntake) GetExtensionByURL(url string) *Extension {
...
func (r *NutritionIntake) GetExtensionsByURL(url string) []*Extension {
...
func (r *NutritionIntake) HasExtensionByURL(url string) bool {
...
func (r *NutritionIntake) GetModifierExtensionByURL(url string) *Extension {
...
func (r *NutritionIntakeConsumedItem) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *NutritionIntakeConsumedItem) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *NutritionIntakeConsumedItem) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *NutritionIntakeConsumedItem) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *NutritionIntakeIngredientLabel) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *NutritionIntakeIngredientLabel) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *NutritionIntakeIngredientLabel) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *NutritionIntakeIngredientLabel) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *NutritionIntakePerformer) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *NutritionIntakePerformer) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *NutritionIntakePerformer) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *NutritionIntakePerformer) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
func (b *NutritionIntakeBuilder) AddInstantiatesCanonicalExt(v *Element) *NutritionIntakeBuilder {
	i := len(b.nutritionIntake.InstantiatesCanonical) - 1
	if i < 0 {
		i = 0
	}
	for len(b.nutritionIntake.InstantiatesCanonicalExt) <= i {
		b.nutritionIntake.InstantiatesCanonicalExt = append(b.nutritionIntake.InstantiatesCanonicalExt, nil)
	}
	b.nutritionIntake.InstantiatesCanonicalExt[i] = v
	return b
}
...
func (b *NutritionIntakeBuilder) AddInstantiatesUriExt(v *Element) *NutritionIntakeBuilder {
	i := len(b.nutritionIntake.InstantiatesUri) - 1
	if i < 0 {
		i = 0
	}
	for len(b.nutritionIntake.InstantiatesUriExt) <= i {
		b.nutritionIntake.InstantiatesUriExt = append(b.nutritionIntake.InstantiatesUriExt, nil)
	}
	b.nutritionIntake.InstantiatesUriExt[i] = v
	return b
}
