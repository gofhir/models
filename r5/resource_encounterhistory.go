...
// encounterHistoryTypeMarker occupies no memory and serializes as the constant
// "EncounterHistory". It replaces a string field that a per-resource MarshalJSON had
...
type encounterHistoryTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (encounterHistoryTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"EncounterHistory"`), nil
}
...
func (*encounterHistoryTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "EncounterHistory")
}

// EncounterHistory represents FHIR EncounterHistory.
type EncounterHistory struct {
	// FHIR resource type. Emitted automatically; see encounterHistoryTypeMarker.
	ResourceType encounterHistoryTypeMarker `json:"resourceType"`
...
func (r *EncounterHistory) GetExtensionByURL(url string) *Extension {
...
func (r *EncounterHistory) GetExtensionsByURL(url string) []*Extension {
...
func (r *EncounterHistory) HasExtensionByURL(url string) bool {
...
func (r *EncounterHistory) GetModifierExtensionByURL(url string) *Extension {
...
func (r *EncounterHistoryLocation) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *EncounterHistoryLocation) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *EncounterHistoryLocation) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *EncounterHistoryLocation) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
