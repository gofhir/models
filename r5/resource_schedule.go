...
func (r *Schedule) GetExtensionByURL(url string) *Extension {
...
func (r *Schedule) GetExtensionsByURL(url string) []*Extension {
...
func (r *Schedule) HasExtensionByURL(url string) bool {
...
func (r *Schedule) GetModifierExtensionByURL(url string) *Extension {
