...
func (r *EnrollmentRequest) GetExtensionByURL(url string) *Extension {
...
func (r *EnrollmentRequest) GetExtensionsByURL(url string) []*Extension {
...
func (r *EnrollmentRequest) HasExtensionByURL(url string) bool {
...
func (r *EnrollmentRequest) GetModifierExtensionByURL(url string) *Extension {
