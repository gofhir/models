...
func (*appointmentResponseTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "AppointmentResponse")
}
...
func (r *AppointmentResponse) GetExtensionByURL(url string) *Extension {
...
func (r *AppointmentResponse) GetExtensionsByURL(url string) []*Extension {
...
func (r *AppointmentResponse) HasExtensionByURL(url string) bool {
...
func (r *AppointmentResponse) GetModifierExtensionByURL(url string) *Extension {
