...
func (r *MedicationStatement) GetExtensionByURL(url string) *Extension {
...
func (r *MedicationStatement) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicationStatement) HasExtensionByURL(url string) bool {
...
func (r *MedicationStatement) GetModifierExtensionByURL(url string) *Extension {
...
func (r *MedicationStatementAdherence) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicationStatementAdherence) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicationStatementAdherence) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *MedicationStatementAdherence) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
