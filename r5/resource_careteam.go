...
// careTeamTypeMarker occupies no memory and serializes as the constant
// "CareTeam". It replaces a string field that a per-resource MarshalJSON had
...
type careTeamTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (careTeamTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"CareTeam"`), nil
}
...
func (*careTeamTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "CareTeam")
}

// CareTeam represents FHIR CareTeam.
type CareTeam struct {
	// FHIR resource type. Emitted automatically; see careTeamTypeMarker.
	ResourceType careTeamTypeMarker `json:"resourceType"`
...
func (r *CareTeam) GetExtensionByURL(url string) *Extension {
...
func (r *CareTeam) GetExtensionsByURL(url string) []*Extension {
...
func (r *CareTeam) HasExtensionByURL(url string) bool {
...
func (r *CareTeam) GetModifierExtensionByURL(url string) *Extension {
...
func (r *CareTeamParticipant) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *CareTeamParticipant) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *CareTeamParticipant) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *CareTeamParticipant) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
