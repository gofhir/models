...
func (r *EnrollmentResponse) GetExtensionByURL(url string) *Extension {
...
func (r *EnrollmentResponse) GetExtensionsByURL(url string) []*Extension {
...
func (r *EnrollmentResponse) HasExtensionByURL(url string) bool {
...
func (r *EnrollmentResponse) GetModifierExtensionByURL(url string) *Extension {
	...
	for {
		...
		case xml.StartElement:
			...
			case "request":
				...
				r.Request = &v
			case "outcome":
				v, ext, err := xmlDecodePrimitiveCode[EnrollmentOutcome](d, t)
				if err != nil {
					return err
				}
				r.Outcome = v
