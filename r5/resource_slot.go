...
func (r *Slot) GetExtensionByURL(url string) *Extension {
...
func (r *Slot) GetExtensionsByURL(url string) []*Extension {
...
func (r *Slot) HasExtensionByURL(url string) bool {
...
func (r *Slot) GetModifierExtensionByURL(url string) *Extension {
