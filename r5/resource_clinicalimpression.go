...
func (r ClinicalImpression) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if r.ChangePattern != nil {
		if err := r.ChangePattern.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "changePattern"}}); err != nil {
			return err
		}
	}
...
func (b *ClinicalImpressionFindingBuilder) SetItem(v CodeableReference) *ClinicalImpressionFindingBuilder {
	b.clinicalImpressionFinding.Item = &v
	return b
}
