...
// endpointTypeMarker occupies no memory and serializes as the constant
// "Endpoint". It replaces a string field that a per-resource MarshalJSON had
...
type endpointTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (endpointTypeMarker) MarshalJSON() ([]byte, error) {
...
func (*endpointTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Endpoint")
}

// Endpoint represents FHIR Endpoint.
type Endpoint struct {
	// FHIR resource type. Emitted automatically; see endpointTypeMarker.
	ResourceType endpointTypeMarker `json:"resourceType"`
...
func (r *Endpoint) GetExtensionByURL(url string) *Extension {
...
func (r *Endpoint) GetExtensionsByURL(url string) []*Extension {
...
func (r *Endpoint) HasExtensionByURL(url string) bool {
...
func (r *Endpoint) GetModifierExtensionByURL(url string) *Extension {
...
func (r *EndpointPayload) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *EndpointPayload) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *EndpointPayload) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *EndpointPayload) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
