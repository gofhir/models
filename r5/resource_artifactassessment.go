...
func (r *ArtifactAssessment) GetExtensionByURL(url string) *Extension {
...
func (r *ArtifactAssessment) GetExtensionsByURL(url string) []*Extension {
...
func (r *ArtifactAssessment) HasExtensionByURL(url string) bool {
...
func (r *ArtifactAssessment) GetModifierExtensionByURL(url string) *Extension {
...
func (r *ArtifactAssessmentContent) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ArtifactAssessmentContent) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ArtifactAssessmentContent) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *ArtifactAssessmentContent) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
