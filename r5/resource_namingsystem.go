...
func (r *NamingSystem) GetExtensionByURL(url string) *Extension {
...
func (r *NamingSystem) GetExtensionsByURL(url string) []*Extension {
...
func (r *NamingSystem) HasExtensionByURL(url string) bool {
...
func (r *NamingSystem) GetModifierExtensionByURL(url string) *Extension {
...
func (r *NamingSystemUniqueId) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *NamingSystemUniqueId) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *NamingSystemUniqueId) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *NamingSystemUniqueId) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
