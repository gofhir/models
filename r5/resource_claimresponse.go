...
func (r *ClaimResponse) GetExtensionByURL(url string) *Extension {
...
func (r *ClaimResponse) GetExtensionsByURL(url string) []*Extension {
...
func (r *ClaimResponse) HasExtensionByURL(url string) bool {
...
func (r *ClaimResponse) GetModifierExtensionByURL(url string) *Extension {
...
func (r *ClaimResponseAddItem) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseAddItem) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseAddItem) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *ClaimResponseAddItem) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseAddItemBodySite) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseAddItemBodySite) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseAddItemBodySite) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseAddItemBodySite) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseAddItemDetail) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseAddItemDetail) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseAddItemDetail) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseAddItemDetail) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseAddItemDetailSubDetail) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseAddItemDetailSubDetail) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseAddItemDetailSubDetail) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseAddItemDetailSubDetail) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseError) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseError) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseError) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseError) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseEvent) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseEvent) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseEvent) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseEvent) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseInsurance) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseInsurance) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseInsurance) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseInsurance) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseItem) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseItem) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseItem) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseItem) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseItemAdjudication) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseItemAdjudication) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseItemAdjudication) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseItemAdjudication) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseItemDetail) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseItemDetail) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseItemDetail) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseItemDetail) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseItemDetailSubDetail) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseItemDetailSubDetail) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseItemDetailSubDetail) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseItemDetailSubDetail) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseItemReviewOutcome) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseItemReviewOutcome) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseItemReviewOutcome) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseItemReviewOutcome) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponsePayment) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponsePayment) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponsePayment) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponsePayment) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseProcessNote) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseProcessNote) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseProcessNote) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseProcessNote) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ClaimResponseTotal) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ClaimResponseTotal) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ClaimResponseTotal) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ClaimResponseTotal) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
func (b *ClaimResponseAddItemBuilder) AddItemSequenceExt(v *Element) *ClaimResponseAddItemBuilder {
	i := len(b.claimResponseAddItem.ItemSequence) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseAddItem.ItemSequenceExt) <= i {
		b.claimResponseAddItem.ItemSequenceExt = append(b.claimResponseAddItem.ItemSequenceExt, nil)
	}
	b.claimResponseAddItem.ItemSequenceExt[i] = v
	return b
}
...
func (b *ClaimResponseAddItemBuilder) AddDetailSequenceExt(v *Element) *ClaimResponseAddItemBuilder {
	i := len(b.claimResponseAddItem.DetailSequence) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseAddItem.DetailSequenceExt) <= i {
		b.claimResponseAddItem.DetailSequenceExt = append(b.claimResponseAddItem.DetailSequenceExt, nil)
	}
	b.claimResponseAddItem.DetailSequenceExt[i] = v
	return b
}
...
func (b *ClaimResponseAddItemBuilder) AddSubdetailSequenceExt(v *Element) *ClaimResponseAddItemBuilder {
	i := len(b.claimResponseAddItem.SubdetailSequence) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseAddItem.SubdetailSequenceExt) <= i {
		b.claimResponseAddItem.SubdetailSequenceExt = append(b.claimResponseAddItem.SubdetailSequenceExt, nil)
	}
	b.claimResponseAddItem.SubdetailSequenceExt[i] = v
	return b
}
...
func (b *ClaimResponseAddItemBuilder) AddNoteNumberExt(v *Element) *ClaimResponseAddItemBuilder {
	i := len(b.claimResponseAddItem.NoteNumber) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseAddItem.NoteNumberExt) <= i {
		b.claimResponseAddItem.NoteNumberExt = append(b.claimResponseAddItem.NoteNumberExt, nil)
	}
	b.claimResponseAddItem.NoteNumberExt[i] = v
	return b
}
...
func (b *ClaimResponseAddItemDetailBuilder) AddNoteNumberExt(v *Element) *ClaimResponseAddItemDetailBuilder {
	i := len(b.claimResponseAddItemDetail.NoteNumber) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseAddItemDetail.NoteNumberExt) <= i {
		b.claimResponseAddItemDetail.NoteNumberExt = append(b.claimResponseAddItemDetail.NoteNumberExt, nil)
	}
	b.claimResponseAddItemDetail.NoteNumberExt[i] = v
	return b
}
...
func (b *ClaimResponseAddItemDetailSubDetailBuilder) AddNoteNumberExt(v *Element) *ClaimResponseAddItemDetailSubDetailBuilder {
	i := len(b.claimResponseAddItemDetailSubDetail.NoteNumber) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseAddItemDetailSubDetail.NoteNumberExt) <= i {
		b.claimResponseAddItemDetailSubDetail.NoteNumberExt = append(b.claimResponseAddItemDetailSubDetail.NoteNumberExt, nil)
	}
	b.claimResponseAddItemDetailSubDetail.NoteNumberExt[i] = v
	return b
}
...
func (b *ClaimResponseErrorBuilder) Build() ClaimResponseError {
	b.claimResponseError.ExpressionExt = alignExtSlots(b.claimResponseError.ExpressionExt, len(b.claimResponseError.Expression))
...
func (b *ClaimResponseErrorBuilder) AddExpressionExt(v *Element) *ClaimResponseErrorBuilder {
	i := len(b.claimResponseError.Expression) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseError.ExpressionExt) <= i {
		b.claimResponseError.ExpressionExt = append(b.claimResponseError.ExpressionExt, nil)
	}
	b.claimResponseError.ExpressionExt[i] = v
	return b
}
...
func (b *ClaimResponseItemBuilder) AddNoteNumberExt(v *Element) *ClaimResponseItemBuilder {
	i := len(b.claimResponseItem.NoteNumber) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseItem.NoteNumberExt) <= i {
		b.claimResponseItem.NoteNumberExt = append(b.claimResponseItem.NoteNumberExt, nil)
	}
	b.claimResponseItem.NoteNumberExt[i] = v
	return b
}
...
func (b *ClaimResponseItemDetailBuilder) AddNoteNumberExt(v *Element) *ClaimResponseItemDetailBuilder {
	i := len(b.claimResponseItemDetail.NoteNumber) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseItemDetail.NoteNumberExt) <= i {
		b.claimResponseItemDetail.NoteNumberExt = append(b.claimResponseItemDetail.NoteNumberExt, nil)
	}
	b.claimResponseItemDetail.NoteNumberExt[i] = v
	return b
}
...
func (b *ClaimResponseItemDetailSubDetailBuilder) AddNoteNumberExt(v *Element) *ClaimResponseItemDetailSubDetailBuilder {
	i := len(b.claimResponseItemDetailSubDetail.NoteNumber) - 1
	if i < 0 {
		i = 0
	}
	for len(b.claimResponseItemDetailSubDetail.NoteNumberExt) <= i {
		b.claimResponseItemDetailSubDetail.NoteNumberExt = append(b.claimResponseItemDetailSubDetail.NoteNumberExt, nil)
	}
	b.claimResponseItemDetailSubDetail.NoteNumberExt[i] = v
	return b
}
