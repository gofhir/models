...
// listTypeMarker occupies no memory and serializes as the constant
// "List". It replaces a string field that a per-resource MarshalJSON had
...
type listTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (listTypeMarker) MarshalJSON() ([]byte, error) {
...
func (*listTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "List")
}

// List represents FHIR List.
type List struct {
	// FHIR resource type. Emitted automatically; see listTypeMarker.
	ResourceType listTypeMarker `json:"resourceType"`
...
func (r *List) GetExtensionByURL(url string) *Extension {
...
func (r *List) GetExtensionsByURL(url string) []*Extension {
...
func (r *List) HasExtensionByURL(url string) bool {
...
func (r *List) GetModifierExtensionByURL(url string) *Extension {
...
func (r *ListEntry) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ListEntry) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ListEntry) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *ListEntry) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
