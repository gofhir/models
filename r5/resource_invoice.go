...
func (r *Invoice) HasExtensionByURL(url string) bool {
...
func (r Invoice) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if r.PeriodPeriod != nil {
		if err := r.PeriodPeriod.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "periodPeriod"}}); err != nil {
			return err
		}
	}
...
// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *InvoiceLineItem) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *InvoiceParticipant) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *InvoiceBuilder) SetCreationExt(v Element) *InvoiceBuilder {
	b.invoice.CreationExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *InvoiceLineItemBuilder) SetServicedDate(v string) *InvoiceLineItemBuilder {
	b.clearServiced()
	b.invoiceLineItem.ServicedDate = &v
	return b
}

// SetServicedDateExt sets the ServicedDateExt field.
func (b *InvoiceLineItemBuilder) SetServicedDateExt(v Element) *InvoiceLineItemBuilder {
	b.invoiceLineItem.ServicedDateExt = &v
	return b
}
...
// that, a chain of setters produced a document with several of them present at
// once, which no FHIR server will accept and which nothing here reported.
func (b *InvoiceLineItemBuilder) SetServicedPeriod(v Period) *InvoiceLineItemBuilder {
	b.clearServiced()
	b.invoiceLineItem.ServicedPeriod = &v
	return b
}
...
func (b *InvoiceLineItemBuilder) AddPriceComponent(v MonetaryComponent) *InvoiceLineItemBuilder {
...
// _field companions of the primitive ones.
func (b *InvoiceLineItemBuilder) clearServiced() {
	b.invoiceLineItem.ServicedDate = nil
	b.invoiceLineItem.ServicedPeriod = nil
}
