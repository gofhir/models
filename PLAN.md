...
- ✅ **`sync.OnceValue` para el modelo FHIRPath.** Confirmado: el heap tras cargar `r4` pasa de **1045 KB a 281 KB**. Los mapas se construyen en la primera llamada, no antes de `main()`.
