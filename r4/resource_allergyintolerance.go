...
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *AllergyIntoleranceBuilder) SetTypeExt(v Element) *AllergyIntoleranceBuilder {
	b.allergyIntolerance.TypeExt = &v
	return b
}
...
func (b *AllergyIntoleranceReactionBuilder) AddManifestation(v CodeableConcept) *AllergyIntoleranceReactionBuilder {
