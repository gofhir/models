...
func (r *ChargeItem) GetExtensionByURL(url string) *Extension {
...
func (r *ChargeItem) GetExtensionsByURL(url string) []*Extension {
...
func (r *ChargeItem) HasExtensionByURL(url string) bool {
...
func (r *ChargeItem) GetModifierExtensionByURL(url string) *Extension {
...
func (r *ChargeItemPerformer) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ChargeItemPerformer) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ChargeItemPerformer) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *ChargeItemPerformer) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
// SetFactorOverrideExt sets the extensions carried by FactorOverride, serialized as
// "_factorOverride".
//
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *ChargeItemBuilder) SetFactorOverrideExt(v Element) *ChargeItemBuilder {
	b.chargeItem.FactorOverrideExt = &v
	return b
}

// SetOverrideReasonExt sets the extensions carried by OverrideReason, serialized as
// "_overrideReason".
//
// This is how a primitive expresses an extension: a data-absent-reason on a
// birthDate lives here, not on the value.
func (b *ChargeItemBuilder) SetOverrideReasonExt(v Element) *ChargeItemBuilder {
	b.chargeItem.OverrideReasonExt = &v
	return b
}
