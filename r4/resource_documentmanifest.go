...
// documentManifestTypeMarker occupies no memory and serializes as the constant
// "DocumentManifest". It replaces a string field that a per-resource MarshalJSON had
...
type documentManifestTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (documentManifestTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"DocumentManifest"`), nil
}
...
func (*documentManifestTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "DocumentManifest")
}

// DocumentManifest represents FHIR DocumentManifest.
type DocumentManifest struct {
	// FHIR resource type. Emitted automatically; see documentManifestTypeMarker.
	ResourceType documentManifestTypeMarker `json:"resourceType"`
...
func (r *DocumentManifest) GetExtensionByURL(url string) *Extension {
...
func (r *DocumentManifest) GetExtensionsByURL(url string) []*Extension {
...
func (r *DocumentManifest) HasExtensionByURL(url string) bool {
...
func (r *DocumentManifest) GetModifierExtensionByURL(url string) *Extension {
...
func (r *DocumentManifestRelated) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *DocumentManifestRelated) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *DocumentManifestRelated) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *DocumentManifestRelated) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
