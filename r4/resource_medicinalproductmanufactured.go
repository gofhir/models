...
func (r *MedicinalProductManufactured) GetExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductManufactured) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicinalProductManufactured) HasExtensionByURL(url string) bool {
...
func (r *MedicinalProductManufactured) GetModifierExtensionByURL(url string) *Extension {
