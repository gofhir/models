...
func (r *MedicinalProductIndication) GetExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductIndication) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicinalProductIndication) HasExtensionByURL(url string) bool {
...
func (r *MedicinalProductIndication) GetModifierExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductIndicationOtherTherapy) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicinalProductIndicationOtherTherapy) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicinalProductIndicationOtherTherapy) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *MedicinalProductIndicationOtherTherapy) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
