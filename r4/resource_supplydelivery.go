...
// supplyDeliveryTypeMarker occupies no memory and serializes as the constant
// "SupplyDelivery". It replaces a string field that a per-resource MarshalJSON had
...
type supplyDeliveryTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (supplyDeliveryTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"SupplyDelivery"`), nil
}
...
func (*supplyDeliveryTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "SupplyDelivery")
}

// SupplyDelivery represents FHIR SupplyDelivery.
type SupplyDelivery struct {
	// FHIR resource type. Emitted automatically; see supplyDeliveryTypeMarker.
	ResourceType supplyDeliveryTypeMarker `json:"resourceType"`
...
func (r *SupplyDelivery) GetExtensionByURL(url string) *Extension {
...
func (r *SupplyDelivery) GetExtensionsByURL(url string) []*Extension {
...
func (r *SupplyDelivery) HasExtensionByURL(url string) bool {
...
func (r *SupplyDelivery) GetModifierExtensionByURL(url string) *Extension {
...
func (r *SupplyDeliverySuppliedItem) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *SupplyDeliverySuppliedItem) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *SupplyDeliverySuppliedItem) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *SupplyDeliverySuppliedItem) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
