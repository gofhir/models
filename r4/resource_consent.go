...
type ConsentPolicy struct {
	...
	AuthorityExt *Element `json:"_authority,omitempty"`
...
func (r *ConsentPolicy) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}
...
func (r *ConsentPolicy) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
func (b ConsentPolicy) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if err := xmlEncodePrimitiveString(e, "authority", b.Authority, b.AuthorityExt); err != nil {
		return err
	}
...
func (b ConsentVerification) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if err := xmlEncodePrimitiveString(e, "verificationDate", b.VerificationDate, b.VerificationDateExt); err != nil {
		return err
	}
