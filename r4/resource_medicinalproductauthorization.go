...
func (r *MedicinalProductAuthorization) HasExtensionByURL(url string) bool {
...
// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicinalProductAuthorizationJurisdictionalAuthorization) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicinalProductAuthorizationProcedure) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
