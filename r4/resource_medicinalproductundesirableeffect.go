...
func (r *MedicinalProductUndesirableEffect) GetExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductUndesirableEffect) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicinalProductUndesirableEffect) HasExtensionByURL(url string) bool {
...
func (r *MedicinalProductUndesirableEffect) GetModifierExtensionByURL(url string) *Extension {
