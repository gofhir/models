...
func (r *GuidanceResponse) GetExtensionByURL(url string) *Extension {
...
func (r *GuidanceResponse) GetExtensionsByURL(url string) []*Extension {
...
func (r *GuidanceResponse) HasExtensionByURL(url string) bool {
...
func (r *GuidanceResponse) GetModifierExtensionByURL(url string) *Extension {
