...
func (r *MedicinalProductPackaged) GetExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductPackaged) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicinalProductPackaged) HasExtensionByURL(url string) bool {
...
func (r *MedicinalProductPackaged) GetModifierExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductPackagedBatchIdentifier) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicinalProductPackagedBatchIdentifier) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicinalProductPackagedBatchIdentifier) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *MedicinalProductPackagedBatchIdentifier) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *MedicinalProductPackagedPackageItem) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicinalProductPackagedPackageItem) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicinalProductPackagedPackageItem) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *MedicinalProductPackagedPackageItem) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
