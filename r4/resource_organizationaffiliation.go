...
// organizationAffiliationTypeMarker occupies no memory and serializes as the constant
// "OrganizationAffiliation". It replaces a string field that a per-resource MarshalJSON had
...
type organizationAffiliationTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (organizationAffiliationTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"OrganizationAffiliation"`), nil
}
...
func (*organizationAffiliationTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "OrganizationAffiliation")
}

// OrganizationAffiliation represents FHIR OrganizationAffiliation.
type OrganizationAffiliation struct {
	// FHIR resource type. Emitted automatically; see organizationAffiliationTypeMarker.
	ResourceType organizationAffiliationTypeMarker `json:"resourceType"`
...
func (r *OrganizationAffiliation) GetExtensionByURL(url string) *Extension {
...
func (r *OrganizationAffiliation) GetExtensionsByURL(url string) []*Extension {
...
func (r *OrganizationAffiliation) HasExtensionByURL(url string) bool {
...
func (r *OrganizationAffiliation) GetModifierExtensionByURL(url string) *Extension {
