...
func (r *MedicinalProductInteraction) GetExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductInteraction) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicinalProductInteraction) HasExtensionByURL(url string) bool {
...
func (r *MedicinalProductInteraction) GetModifierExtensionByURL(url string) *Extension {
...
func (r *MedicinalProductInteractionInteractant) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicinalProductInteractionInteractant) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicinalProductInteractionInteractant) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *MedicinalProductInteractionInteractant) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
