...
func (r *Flag) GetExtensionByURL(url string) *Extension {
...
func (r *Flag) GetExtensionsByURL(url string) []*Extension {
...
func (r *Flag) HasExtensionByURL(url string) bool {
...
func (r *Flag) GetModifierExtensionByURL(url string) *Extension {
