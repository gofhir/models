...
func (b TerminologyCapabilitiesCodeSystemVersion) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	if err := xmlEncodePrimitiveStringArray(e, "language", b.Language, b.LanguageExt); err != nil {
		return err
	}
...
func (b *TerminologyCapabilitiesCodeSystemVersionBuilder) AddLanguage(v string) *TerminologyCapabilitiesCodeSystemVersionBuilder {
