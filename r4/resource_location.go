...
func (*locationTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Location")
}
...
func (r *Location) GetExtensionByURL(url string) *Extension {
...
func (r *Location) GetExtensionsByURL(url string) []*Extension {
...
func (r *Location) HasExtensionByURL(url string) bool {
...
func (r *Location) GetModifierExtensionByURL(url string) *Extension {
...
func (r *LocationHoursOfOperation) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *LocationHoursOfOperation) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *LocationHoursOfOperation) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *LocationHoursOfOperation) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *LocationPosition) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *LocationPosition) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *LocationPosition) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *LocationPosition) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
func (b *LocationBuilder) AddAliasExt(v *Element) *LocationBuilder {
	i := len(b.location.Alias) - 1
	if i < 0 {
		i = 0
	}
	for len(b.location.AliasExt) <= i {
		b.location.AliasExt = append(b.location.AliasExt, nil)
	}
	b.location.AliasExt[i] = v
	return b
}
...
func (b *LocationHoursOfOperationBuilder) AddDaysOfWeekExt(v *Element) *LocationHoursOfOperationBuilder {
	i := len(b.locationHoursOfOperation.DaysOfWeek) - 1
	if i < 0 {
		i = 0
	}
	for len(b.locationHoursOfOperation.DaysOfWeekExt) <= i {
		b.locationHoursOfOperation.DaysOfWeekExt = append(b.locationHoursOfOperation.DaysOfWeekExt, nil)
	}
	b.locationHoursOfOperation.DaysOfWeekExt[i] = v
	return b
}
