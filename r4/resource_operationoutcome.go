...
func (r *OperationOutcome) GetExtensionByURL(url string) *Extension {
...
func (r *OperationOutcome) GetExtensionsByURL(url string) []*Extension {
...
func (r *OperationOutcome) HasExtensionByURL(url string) bool {
...
func (r *OperationOutcome) GetModifierExtensionByURL(url string) *Extension {
...
func (r *OperationOutcomeIssue) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *OperationOutcomeIssue) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *OperationOutcomeIssue) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *OperationOutcomeIssue) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
