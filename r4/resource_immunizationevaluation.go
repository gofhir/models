...
func (r *ImmunizationEvaluation) GetExtensionByURL(url string) *Extension {
...
func (r *ImmunizationEvaluation) GetExtensionsByURL(url string) []*Extension {
...
func (r *ImmunizationEvaluation) HasExtensionByURL(url string) bool {
...
func (r *ImmunizationEvaluation) GetModifierExtensionByURL(url string) *Extension {
