...
func (r *ResearchDefinition) GetExtensionByURL(url string) *Extension {
...
func (r *ResearchDefinition) GetExtensionsByURL(url string) []*Extension {
...
func (r *ResearchDefinition) HasExtensionByURL(url string) bool {
...
func (r *ResearchDefinition) GetModifierExtensionByURL(url string) *Extension {
