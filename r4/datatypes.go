...
//
// The result points into the slice, so writing through it edits the value.
func (r *SubstanceAmount) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *SubstanceAmount) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *SubstanceAmount) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *SubstanceAmount) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *MetadataResource) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MetadataResource) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MetadataResource) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *MetadataResource) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *SubstanceAmountReferenceRange) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *SubstanceAmountReferenceRange) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *SubstanceAmountReferenceRange) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// MarshalXML serializes SubstanceAmount to FHIR-conformant XML.
func (d SubstanceAmount) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if start.Name.Local == "" {
		start.Name.Local = "SubstanceAmount"
	}
	if d.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{Name: xml.Name{Local: "id"}, Value: *d.Id})
	}
	...
	if d.AmountQuantity != nil {
		if err := d.AmountQuantity.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "amountQuantity"}}); err != nil {
			return err
		}
	}
	if d.AmountRange != nil {
		if err := d.AmountRange.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "amountRange"}}); err != nil {
			return err
		}
	}
	if err := xmlEncodePrimitiveString(e, "amountString", d.AmountString, d.AmountStringExt); err != nil {
		return err
	}
	if d.AmountType != nil {
		if err := d.AmountType.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "amountType"}}); err != nil {
			return err
		}
	}
	if err := xmlEncodePrimitiveString(e, "amountText", d.AmountText, d.AmountTextExt); err != nil {
		return err
	}
	if d.ReferenceRange != nil {
		if err := d.ReferenceRange.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "referenceRange"}}); err != nil {
			return err
		}
	}
...
// MarshalXML serializes MetadataResource to FHIR-conformant XML.
func (d MetadataResource) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if start.Name.Local == "" {
		start.Name.Local = "MetadataResource"
	}
	if d.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{Name: xml.Name{Local: "id"}, Value: *d.Id})
	}
	...
	if d.Meta != nil {
		if err := d.Meta.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "meta"}}); err != nil {
			return err
		}
	}
	if err := xmlEncodePrimitiveString(e, "implicitRules", d.ImplicitRules, d.ImplicitRulesExt); err != nil {
		return err
	}
	if err := xmlEncodePrimitiveString(e, "language", d.Language, d.LanguageExt); err != nil {
		return err
	...
	if d.Text != nil {
		if err := d.Text.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "text"}}); err != nil {
			return err
		}
	}
	...
	if err := xmlEncodePrimitiveBool(e, "experimental", d.Experimental, d.ExperimentalExt); err != nil {
		return err
	}
	if err := xmlEncodePrimitiveString(e, "date", d.Date, d.DateExt); err != nil {
		return err
	}
	if err := xmlEncodePrimitiveString(e, "publisher", d.Publisher, d.PublisherExt); err != nil {
		return err
	}
	for _, item := range d.Contact {
		if err := item.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "contact"}}); err != nil {
...
// MarshalXML serializes SubstanceAmountReferenceRange to FHIR-conformant XML.
func (b SubstanceAmountReferenceRange) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if start.Name.Local == "" {
		start.Name.Local = "SubstanceAmount.referenceRange"
	}
	if b.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{Name: xml.Name{Local: "id"}, Value: *b.Id})
	}
	...
	if b.LowLimit != nil {
		if err := b.LowLimit.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "lowLimit"}}); err != nil {
			return err
		}
	}
	if b.HighLimit != nil {
		if err := b.HighLimit.MarshalXML(e, xml.StartElement{Name: xml.Name{Local: "highLimit"}}); err != nil {
			return err
		}
	}
...
// UnmarshalXML deserializes SubstanceAmount from FHIR-conformant XML.
func (r *SubstanceAmount) UnmarshalXML(dec *xml.Decoder, start xml.StartElement) error {
	for _, attr := range start.Attr {
		if attr.Name.Local == "id" {
			v := attr.Value
			r.Id = &v
...
// UnmarshalXML deserializes MetadataResource from FHIR-conformant XML.
func (r *MetadataResource) UnmarshalXML(dec *xml.Decoder, start xml.StartElement) error {
	for _, attr := range start.Attr {
		if attr.Name.Local == "id" {
			v := attr.Value
			r.Id = &v
...
// UnmarshalXML deserializes SubstanceAmountReferenceRange from FHIR-conformant XML.
