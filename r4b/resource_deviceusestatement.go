...
func (*deviceUseStatementTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "DeviceUseStatement")
}
...
func (r *DeviceUseStatement) GetExtensionByURL(url string) *Extension {
...
func (r *DeviceUseStatement) GetExtensionsByURL(url string) []*Extension {
...
func (r *DeviceUseStatement) HasExtensionByURL(url string) bool {
...
func (r *DeviceUseStatement) GetModifierExtensionByURL(url string) *Extension {
