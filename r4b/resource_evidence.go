...
// WithEvidenceStudyType sets the StudyType field.
//
// Deprecated: use EvidenceBuilder.SetStudyType instead; removed in v2.
func WithEvidenceStudyType(v CodeableConcept) EvidenceOption {
	return func(r *Evidence) {
		r.StudyType = &v
	}
}
