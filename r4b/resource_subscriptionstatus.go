...
// subscriptionStatusTypeMarker occupies no memory and serializes as the constant
// "SubscriptionStatus". It replaces a string field that a per-resource MarshalJSON had
...
type subscriptionStatusTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (subscriptionStatusTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"SubscriptionStatus"`), nil
}
...
func (*subscriptionStatusTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "SubscriptionStatus")
}

// SubscriptionStatus represents FHIR SubscriptionStatus.
type SubscriptionStatus struct {
	// FHIR resource type. Emitted automatically; see subscriptionStatusTypeMarker.
	ResourceType subscriptionStatusTypeMarker `json:"resourceType"`
...
func (r *SubscriptionStatus) GetExtensionByURL(url string) *Extension {
...
func (r *SubscriptionStatus) GetExtensionsByURL(url string) []*Extension {
...
func (r *SubscriptionStatus) HasExtensionByURL(url string) bool {
...
func (r *SubscriptionStatus) GetModifierExtensionByURL(url string) *Extension {
...
func (r *SubscriptionStatusNotificationEvent) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *SubscriptionStatusNotificationEvent) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *SubscriptionStatusNotificationEvent) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *SubscriptionStatusNotificationEvent) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
