...
func (r *MedicationDispense) GetExtensionByURL(url string) *Extension {
...
func (r *MedicationDispense) GetExtensionsByURL(url string) []*Extension {
...
func (r *MedicationDispense) HasExtensionByURL(url string) bool {
...
func (r *MedicationDispense) GetModifierExtensionByURL(url string) *Extension {
...
func (r *MedicationDispensePerformer) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicationDispensePerformer) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicationDispensePerformer) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *MedicationDispensePerformer) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *MedicationDispenseSubstitution) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *MedicationDispenseSubstitution) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *MedicationDispenseSubstitution) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *MedicationDispenseSubstitution) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
// AddResponsibleParty adds a ResponsibleParty element.
func (b *MedicationDispenseSubstitutionBuilder) AddResponsibleParty(v Reference) *MedicationDispenseSubstitutionBuilder {
	b.medicationDispenseSubstitution.ResponsibleParty = append(b.medicationDispenseSubstitution.ResponsibleParty, v)
	return b
}
