...
// linkageTypeMarker occupies no memory and serializes as the constant
// "Linkage". It replaces a string field that a per-resource MarshalJSON had
...
type linkageTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (linkageTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"Linkage"`), nil
}
...
func (*linkageTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Linkage")
}

// Linkage represents FHIR Linkage.
type Linkage struct {
	// FHIR resource type. Emitted automatically; see linkageTypeMarker.
	ResourceType linkageTypeMarker `json:"resourceType"`
...
func (r *Linkage) GetExtensionByURL(url string) *Extension {
...
func (r *Linkage) GetExtensionsByURL(url string) []*Extension {
...
func (r *Linkage) HasExtensionByURL(url string) bool {
...
func (r *Linkage) GetModifierExtensionByURL(url string) *Extension {
...
func (r *LinkageItem) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *LinkageItem) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *LinkageItem) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *LinkageItem) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
