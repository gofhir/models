...
var CharacteristicCombinationTable = map[CharacteristicCombination]CharacteristicCombinationInfo{
	CharacteristicCombinationIntersection: {"http://hl7.org/fhir/characteristic-combination", "intersection"},
	CharacteristicCombinationUnion:        {"http://hl7.org/fhir/characteristic-combination", "union"},
}
...
var RemittanceOutcomeTable = map[RemittanceOutcome]RemittanceOutcomeInfo{
	...
	RemittanceOutcomeComplete: {"http://hl7.org/fhir/remittance-outcome", "Complete"},
	RemittanceOutcomeError:    {"http://hl7.org/fhir/remittance-outcome", "Error"},
	RemittanceOutcomePartial:  {"http://hl7.org/fhir/remittance-outcome", "Partial"},
}
...
type SubscriptionTopicFilterBySearchModifierInfo struct {
	System  string
	Display string
}

// SubscriptionTopicFilterBySearchModifierTable maps each code to what the specification says about it.
var SubscriptionTopicFilterBySearchModifierTable = map[SubscriptionTopicFilterBySearchModifier]SubscriptionTopicFilterBySearchModifierInfo{
	SubscriptionTopicFilterBySearchModifierEqual:  {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "="},
	SubscriptionTopicFilterBySearchModifierEq:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Equal"},
	SubscriptionTopicFilterBySearchModifierNe:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Not Equal"},
	SubscriptionTopicFilterBySearchModifierGt:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Greater Than"},
	SubscriptionTopicFilterBySearchModifierLt:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Less Than"},
	SubscriptionTopicFilterBySearchModifierGe:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Greater Than or Equal"},
	SubscriptionTopicFilterBySearchModifierLe:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Less Than or Equal"},
	SubscriptionTopicFilterBySearchModifierSa:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Starts After"},
	SubscriptionTopicFilterBySearchModifierEb:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Ends Before"},
	SubscriptionTopicFilterBySearchModifierAp:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Approximately"},
	SubscriptionTopicFilterBySearchModifierAbove:  {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Above"},
	SubscriptionTopicFilterBySearchModifierBelow:  {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Below"},
	SubscriptionTopicFilterBySearchModifierIn:     {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "In"},
	SubscriptionTopicFilterBySearchModifierNotIn:  {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Not In"},
	SubscriptionTopicFilterBySearchModifierOfType: {"http://terminology.hl7.org/CodeSystem/subscription-search-modifier", "Of Type"},
}

// SubscriptionTopicFilterBySearchModifierValues returns every value this type allows, in specification order.
//
// For populating a form, validating input against the set, or checking that a
// switch covers everything.
func SubscriptionTopicFilterBySearchModifierValues() []SubscriptionTopicFilterBySearchModifier {
	return []SubscriptionTopicFilterBySearchModifier{
		SubscriptionTopicFilterBySearchModifierEqual,
		SubscriptionTopicFilterBySearchModifierEq,
		SubscriptionTopicFilterBySearchModifierNe,
		SubscriptionTopicFilterBySearchModifierGt,
		SubscriptionTopicFilterBySearchModifierLt,
		SubscriptionTopicFilterBySearchModifierGe,
		SubscriptionTopicFilterBySearchModifierLe,
		SubscriptionTopicFilterBySearchModifierSa,
		SubscriptionTopicFilterBySearchModifierEb,
		SubscriptionTopicFilterBySearchModifierAp,
		SubscriptionTopicFilterBySearchModifierAbove,
		SubscriptionTopicFilterBySearchModifierBelow,
		SubscriptionTopicFilterBySearchModifierIn,
		SubscriptionTopicFilterBySearchModifierNotIn,
		SubscriptionTopicFilterBySearchModifierOfType,
	}
}
...
// Falling back to the code rather than to an empty string means the result can go
// straight in front of a person.
func (c SubscriptionTopicFilterBySearchModifier) Display() string {
	if info, ok := SubscriptionTopicFilterBySearchModifierTable[c]; ok && info.Display != "" {
		return info.Display
	}
	return string(c)
}
...
// System returns the CodeSystem URL this code belongs to, or "" if the code is not
// one the specification defines.
func (c SubscriptionTopicFilterBySearchModifier) System() string {
	return SubscriptionTopicFilterBySearchModifierTable[c].System
}

// Coding returns this code as a Coding, with its system and display filled in —
// what a CodeableConcept needs, and where the system URL usually gets copied wrong
// by hand.
func (c SubscriptionTopicFilterBySearchModifier) Coding() Coding {
	system, display := c.System(), c.Display()
	coding := Coding{Code: Ptr(string(c)), Display: &display}
	if system != "" {
		coding.System = &system
...
// VariableTypeTable maps each code to what the specification says about it.
var VariableTypeTable = map[VariableType]VariableTypeInfo{
	VariableTypeDichotomous: {"http://hl7.org/fhir/variable-type", "Dichotomous"},
	VariableTypeContinuous:  {"http://hl7.org/fhir/variable-type", "Continuous"},
	VariableTypeDescriptive: {"http://hl7.org/fhir/variable-type", "Descriptive"},
}

// VariableTypeValues returns every value this type allows, in specification order.
//
// For populating a form, validating input against the set, or checking that a
// switch covers everything.
...
// Falling back to the code rather than to an empty string means the result can go
// straight in front of a person.
func (c VariableType) Display() string {
	if info, ok := VariableTypeTable[c]; ok && info.Display != "" {
		return info.Display
	}
	return string(c)
}
...
// System returns the CodeSystem URL this code belongs to, or "" if the code is not
// one the specification defines.
func (c VariableType) System() string {
	return VariableTypeTable[c].System
}

// Coding returns this code as a Coding, with its system and display filled in —
// what a CodeableConcept needs, and where the system URL usually gets copied wrong
// by hand.
func (c VariableType) Coding() Coding {
	system, display := c.System(), c.Display()
	coding := Coding{Code: Ptr(string(c)), Display: &display}
	if system != "" {
		coding.System = &system
...
var StatusTable = map[Status]StatusInfo{
	StatusAttested:   {"http://hl7.org/fhir/verificationresult-status", "Attested"},
	StatusValidated:  {"http://hl7.org/fhir/verificationresult-status", "Validated"},
	StatusInProcess:  {"http://hl7.org/fhir/verificationresult-status", "In process"},
	StatusReqRevalid: {"http://hl7.org/fhir/verificationresult-status", "Requires revalidation"},
	StatusValFail:    {"http://hl7.org/fhir/verificationresult-status", "Validation failed"},
	StatusRevalFail:  {"http://hl7.org/fhir/verificationresult-status", "Re-Validation failed"},
}
