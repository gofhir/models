...
// mediaTypeMarker occupies no memory and serializes as the constant
// "Media". It replaces a string field that a per-resource MarshalJSON had
...
type mediaTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (mediaTypeMarker) MarshalJSON() ([]byte, error) {
...
func (*mediaTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Media")
}

// Media represents FHIR Media.
type Media struct {
	// FHIR resource type. Emitted automatically; see mediaTypeMarker.
	ResourceType mediaTypeMarker `json:"resourceType"`
...
func (r *Media) GetExtensionByURL(url string) *Extension {
...
func (r *Media) GetExtensionsByURL(url string) []*Extension {
...
func (r *Media) HasExtensionByURL(url string) bool {
...
func (r *Media) GetModifierExtensionByURL(url string) *Extension {
