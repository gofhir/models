...
func (r *SubscriptionChannel) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *SubscriptionChannel) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *SubscriptionChannel) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *SubscriptionChannel) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
func (b *SubscriptionChannelBuilder) AddHeaderExt(v *Element) *SubscriptionChannelBuilder {
	i := len(b.subscriptionChannel.Header) - 1
	if i < 0 {
		i = 0
	}
	for len(b.subscriptionChannel.HeaderExt) <= i {
		b.subscriptionChannel.HeaderExt = append(b.subscriptionChannel.HeaderExt, nil)
	}
	b.subscriptionChannel.HeaderExt[i] = v
	return b
}
