...
func (*procedureTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "Procedure")
}
...
func (r *Procedure) GetExtensionByURL(url string) *Extension {
...
func (r *Procedure) GetExtensionsByURL(url string) []*Extension {
...
func (r *Procedure) HasExtensionByURL(url string) bool {
...
func (r *Procedure) GetModifierExtensionByURL(url string) *Extension {
...
func (r *ProcedureFocalDevice) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ProcedureFocalDevice) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ProcedureFocalDevice) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *ProcedureFocalDevice) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
//
// The result points into the slice, so writing through it edits the value.
func (r *ProcedurePerformer) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *ProcedurePerformer) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *ProcedurePerformer) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
// URL, or nil. Kept separate from GetExtensionByURL because a modifier extension
// changes the meaning of the element it is on.
func (r *ProcedurePerformer) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
...
func (b *ProcedureBuilder) AddInstantiatesCanonicalExt(v *Element) *ProcedureBuilder {
	i := len(b.procedure.InstantiatesCanonical) - 1
	if i < 0 {
		i = 0
	}
	for len(b.procedure.InstantiatesCanonicalExt) <= i {
		b.procedure.InstantiatesCanonicalExt = append(b.procedure.InstantiatesCanonicalExt, nil)
	}
	b.procedure.InstantiatesCanonicalExt[i] = v
	return b
}
...
func (b *ProcedureBuilder) AddInstantiatesUriExt(v *Element) *ProcedureBuilder {
	i := len(b.procedure.InstantiatesUri) - 1
	if i < 0 {
		i = 0
	}
	for len(b.procedure.InstantiatesUriExt) <= i {
		b.procedure.InstantiatesUriExt = append(b.procedure.InstantiatesUriExt, nil)
	}
	b.procedure.InstantiatesUriExt[i] = v
	return b
}
