...
func (*researchElementDefinitionTypeMarker) UnmarshalJSON([]byte) error { return nil }
...
func WithResearchElementDefinitionVariableType(v VariableType) ResearchElementDefinitionOption {
	return func(r *ResearchElementDefinition) {
		r.VariableType = &v
	}
}
