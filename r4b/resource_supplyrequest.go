...
func (*supplyRequestTypeMarker) UnmarshalJSON(data []byte) error {
	return checkResourceType(data, "SupplyRequest")
}
...
func (r *SupplyRequest) GetExtensionByURL(url string) *Extension {
...
func (r *SupplyRequest) GetExtensionsByURL(url string) []*Extension {
...
func (r *SupplyRequest) HasExtensionByURL(url string) bool {
...
func (r *SupplyRequest) GetModifierExtensionByURL(url string) *Extension {
...
func (r *SupplyRequestParameter) GetExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.Extension, url)
}

// GetExtensionsByURL returns every extension with the given URL. A URL may repeat
// where the extension's cardinality allows it.
func (r *SupplyRequestParameter) GetExtensionsByURL(url string) []*Extension {
	return ExtensionsByURL(r.Extension, url)
}

// HasExtensionByURL reports whether any extension carries the given URL, which
// is the whole meaning of the extensions that have no value.
func (r *SupplyRequestParameter) HasExtensionByURL(url string) bool {
	return HasExtensionByURL(r.Extension, url)
}
...
func (r *SupplyRequestParameter) GetModifierExtensionByURL(url string) *Extension {
	return ExtensionByURL(r.ModifierExtension, url)
}
