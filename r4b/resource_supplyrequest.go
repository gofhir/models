...
// supplyRequestTypeMarker occupies no memory and serializes as the constant
// "SupplyRequest". It replaces a string field that a per-resource MarshalJSON had
...
type supplyRequestTypeMarker struct{}

// MarshalJSON writes the resource type as a JSON string.
func (supplyRequestTypeMarker) MarshalJSON() ([]byte, error) {
	return []byte(`"SupplyRequest"`), nil
}
...
func (*supplyRequestTypeMarker) UnmarshalJSON([]byte) error { return nil }

// SupplyRequest represents FHIR SupplyRequest.
type SupplyRequest struct {
	// FHIR resource type. Emitted automatically; see supplyRequestTypeMarker.
	ResourceType supplyRequestTypeMarker `json:"resourceType"`
